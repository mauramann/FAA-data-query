...
flight_report <- read.csv('data/flight_reports.csv')
...
I observed a cylical pattern where the past three day average number of flights was lower on Sunday, Monday, and Tuesday and higher on Wednesday, Thursday, Friday, and Saturday. This means when weekend numbers are rolled into the averages, they are lower.
...
# Clean data frame
flight_report <- flight_report |> filter(FlightDate != "2019-06-01")
flight_report$three_day_avg <- as.numeric(flight_report$three_day_avg)
...
Secondly, I looked at the overall break down of number of flights per week day. The weekend has a slightly larger number of total flights, however, the weekdays are all about even and not far off from the weekend values. This tells me that even though Saturday and Sunday have higher flight numbers, the past three day averages for Sunday, Monday, and Tuesday get lowered either by a lower week day value and/or week day values having consistent values throughout the entire month compared to weekends. 
